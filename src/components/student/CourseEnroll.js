...
const CourseEnroll = (props) => {
    ...
    fetch(`/api/enrollments?secNo=${selectedSection}&studentId=3`, {
        method: 'POST',
        headers: {
    ...
    .then(response => {
        if (response.ok) {
           ...
           alert('Failed to enroll.  Please try again.'); // unsuccessful enrollment message
        }
    })
